...
var LangViews = function (_mix$with) {
  ...
  _createClass(LangViews, [{
    ...
    value: function pushParams() {
      ...
      _get(LangViews.prototype.__proto__ || Object.getPrototypeOf(LangViews.prototype), 'pushParams', this).call(this, 'page', clear);
    }
    ...
    value: function getPageViewsData(interWikiData) {
      ...
      var makeRequest = function makeRequest(dbName) {
        ...
        var url = 'https://wikimedia.org/api/rest_v1/metrics/pageviews/per-article/' + data.lang + '.' + _this6.baseProject + ('/' + _this6.$platformSelector.val() + '/' + _this6.$agentSelector.val() + '/' + uriEncodedPageName + '/daily') + ('/' + startDate.format(_this6.config.timestampFormat) + '/' + endDate.format(_this6.config.timestampFormat));
        ...
        promise.done(function (pvData) {
          ...
          var failedPageLink = _this6.getPageLink(data.title, data.lang + '.' + _this6.baseProject + '.org');
          ...
          if (cassandraError) {
            ...
            _this6.writeMessage(failedPageLink + ': ' + $.i18n('api-error', 'Pageviews API') + ' - ' + errorMessage);
          }

          // unless it was a 404, don't cache this series of requests
          if (errorData.status !== 404) _this6.hadFailure = true;
        }).always(function () {
    ...
    value: function popParams() {
      ...
      if (params.page) {
        this.getPageInfo([params.page]).done(function (data) {
          ...
          _this8.$sourceInput.val(normalizedPage);
          _this8.processInput();
        }).fail(function () {
    ...
    value: function processInput() {
      ...
      var readyForRendering = function readyForRendering() {
        ...
        $('.output-params').html(_this9.$dateRangeSelector.val());
      ...
      var dbName = Object.keys(siteMap).find(function (key) {
        return siteMap[key] === _this9.$projectInput.val();
      });
