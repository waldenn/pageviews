  ...
  _createClass(RedirectViews, [{
    ...
    value: function getPageViewsData(redirectData) {
      ...
      var makeRequest = function makeRequest(page) {
        ...
        var url = 'https://wikimedia.org/api/rest_v1/metrics/pageviews/per-article/' + _this6.project + ('/' + _this6.$platformSelector.val() + '/' + _this6.$agentSelector.val() + '/' + uriEncodedPageName + '/daily') + ('/' + startDate.format(_this6.config.timestampFormat) + '/' + endDate.format(_this6.config.timestampFormat));
